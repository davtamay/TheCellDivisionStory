    ...
    public class AssetLoaderBase : IDisposable
    {
        ...
        protected GameObject BuildGameObject(AssetLoaderOptions options, string basePath = null, GameObject wrapperGameObject = null)
        {
            ...
            if (MaterialData != null && (options == null || !options.DontLoadMaterials))
            {
                ...
                //THIS IS WHERE THE PRBLEM OF FREEZING SCREENS OCCURS //DO I HAVE ALL THE MATERIALS NEEDED IN THIS RESOURCE DELETE THE ERROR ONE?
            ...
            if (gameObject != null)
            {
                ...
                if (CameraData != null && (options == null || !options.DontLoadCameras))
                {
                    ...
                    {
                        //COMMENTED EVERYTHING IN THIS CLASS BECAUSE OF CAMERA ISSUES
        ...
        {
            //CAUSES CAMERA TO FREEZE WHEN IMPORTING CERTAIN MODELS WITH SUCH MATERIAL PROPERTIES
            var dummy = false;
            ...
            ////////////////////CUSTOM IMPLEMENTATION OF MATERIAL SETTINGS/////////////////////
            ///FIXME Not using internal modification of material since it still does not work due to the bug that freezes the screen
            var material = LoadMaterial(materialData.Name, options, hasAlpha, hasSpecular); //new Material(Shader.Find("Diffuse"))
